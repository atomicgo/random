...
- [func Float32\(minimum, maximum float32\) float32](<#Float32>)
- [func Float32Slice\(minimum, maximum float32, count int\) \[\]float32](<#Float32Slice>)
- [func Float32SliceUnique\(minimum, maximum float32, count int\) \[\]float32](<#Float32SliceUnique>)
- [func Float64\(minimum, maximum float64\) float64](<#Float64>)
- [func Float64Slice\(minimum, maximum float64, count int\) \[\]float64](<#Float64Slice>)
- [func Float64SliceUnique\(minimum, maximum float64, count int\) \[\]float64](<#Float64SliceUnique>)
- [func Int\(minimum, maximum int\) int](<#Int>)
- [func Int16\(minimum, maximum int16\) int16](<#Int16>)
- [func Int16Slice\(minimum, maximum, count int16\) \[\]int16](<#Int16Slice>)
- [func Int16SliceUnique\(minimum, maximum int16, count int\) \[\]int16](<#Int16SliceUnique>)
- [func Int32\(minimum, maximum int32\) int32](<#Int32>)
- [func Int32Slice\(minimum, maximum, count int32\) \[\]int32](<#Int32Slice>)
- [func Int32SliceUnique\(minimum, maximum int32, count int\) \[\]int32](<#Int32SliceUnique>)
- [func Int64\(minimum, maximum int64\) int64](<#Int64>)
- [func Int64Slice\(minimum, maximum, count int64\) \[\]int64](<#Int64Slice>)
- [func Int64SliceUnique\(minimum, maximum int64, count int\) \[\]int64](<#Int64SliceUnique>)
- [func Int8\(minimum, maximum int8\) int8](<#Int8>)
- [func Int8Slice\(minimum, maximum, count int8\) \[\]int8](<#Int8Slice>)
- [func Int8SliceUnique\(minimum, maximum int8, count int\) \[\]int8](<#Int8SliceUnique>)
- [func IntSlice\(minimum, maximum, count int\) \[\]int](<#IntSlice>)
- [func IntSliceUnique\(minimum, maximum, count int\) \[\]int](<#IntSliceUnique>)
...
- [func Uint\(minimum, maximum uint\) uint](<#Uint>)
- [func Uint16\(minimum, maximum uint16\) uint16](<#Uint16>)
- [func Uint16Slice\(minimum, maximum, count uint16\) \[\]uint16](<#Uint16Slice>)
- [func Uint16SliceUnique\(minimum, maximum uint16, count int\) \[\]uint16](<#Uint16SliceUnique>)
- [func Uint32\(minimum, maximum uint32\) uint32](<#Uint32>)
- [func Uint32Slice\(minimum, maximum, count uint32\) \[\]uint32](<#Uint32Slice>)
- [func Uint32SliceUnique\(minimum, maximum uint32, count int\) \[\]uint32](<#Uint32SliceUnique>)
- [func Uint64\(minimum, maximum uint64\) uint64](<#Uint64>)
- [func Uint64Slice\(minimum, maximum, count uint64\) \[\]uint64](<#Uint64Slice>)
- [func Uint64SliceUnique\(minimum, maximum uint64, count int\) \[\]uint64](<#Uint64SliceUnique>)
- [func Uint8\(minimum, maximum uint8\) uint8](<#Uint8>)
- [func Uint8Slice\(minimum, maximum, count uint8\) \[\]uint8](<#Uint8Slice>)
- [func Uint8SliceUnique\(minimum, maximum uint8, count int\) \[\]uint8](<#Uint8SliceUnique>)
- [func UintSlice\(minimum, maximum, count uint\) \[\]uint](<#UintSlice>)
- [func UintSliceUnique\(minimum, maximum uint, count int\) \[\]uint](<#UintSliceUnique>)
...
<a name="Seed"></a>
## func [Seed](<https://github.com/atomicgo/random/blob/main/random.go#L21>)
